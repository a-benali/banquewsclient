 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.edu.abenali/", wsdlLocation = "http://localhost:9191/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.edu.abenali/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.edu.abenali/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.edu.abenali/", "BanqueServicePort"), BanqueService.class, features);
    }
