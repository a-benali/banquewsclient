...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.edu.abenali/", "convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.edu.abenali/", "convertResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.edu.abenali/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.edu.abenali/", "getCompteResponse");
    private final static QName _GetComptes_QNAME = new QName("http://ws.edu.abenali/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://ws.edu.abenali/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "convertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.edu.abenali/", name = "getComptesResponse")
